      ...
      <div className="grid grid-cols-12 gap-2 items-end mb-3">
        ...
        <div className="col-span-5 min-w-0">
          ...
          <div className="relative">
            <input
              type="date"
              className="block w-full min-w-0 max-w-full box-border appearance-none bg-white text-[#6b7db3] border border-[#6b7db3] rounded-full px-4 py-3 text-sm min-h-[44px] min-w-[130px]"
              value={startBetween}
            ...
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none text-[#6b7db3]">
